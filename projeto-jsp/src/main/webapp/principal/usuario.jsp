                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                        		...
                                        		<form class="form-material" action="<%= request.getContextPath() %>/ServletUsuarioController" method="post" id="formUser">
                                                            ...
                                                            <div class="form-group form de fault form-satic-label">
																<select class="form-control"
																	...
																	<option value="SECRETARIA"  <%  modelLogin = (ModelLogin) request.getAttribute("modolLogin");
																	...
																	<option value="AUXILIAR"  <% modelLogin = (ModelLogin) request.getAttribute("modolLogin");
                                                    ...
                                                    <label class="float-label">Login</label>
															...
															<button type="button" class="btn btn-success waves-effect waves-light" onclick="criarDeleteAjax();">Excluir</button>
															<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalUsuario">Pesquisar</button>
                                                    </form>
                                        </div>
                                        </div>
                                        </div>
...
<span id="totalResultados"></span>
    ...
    function criarDeleteAjax() {
    	...
    	function criarDelete() {
    		...
    		if(confirm('deseja realmente excluir os dado?')){
